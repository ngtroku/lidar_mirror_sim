...
def calc_reward_polar(score, distance, threshold):
    #print(f"score: {score}, distance: {distance}, fd: {fd(distance, threshold)}")
...
def global_score_polar(score, threshold=8):
    ...
    for index in sorted_index:
        ...
        smvs_frame += calc_reward_polar(score_local, distance, threshold) # 5 deg / threshold, e.g. threshold=8 is 40 deg
